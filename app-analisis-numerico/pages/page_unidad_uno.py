...
def view_unidad_uno(page):
    ...
    txt_x1 = ft.TextField(label='Ingrese valor de x1')
    txt_xu = ft.TextField(label='Ingrese valor de xu')
    ...
    btn_graficar = ft.ElevatedButton(text='Graficar', on_click=grafica)
    ...
    return( 
           listview
        #    ft.ResponsiveRow( # Responsive Row me permite dar responsividad a los componentes
